            ...
            <div class="ps-dark-overlay2">
                <div class="container">
                    <div class="ps-banner-contentv3">
                        <h4>Privacy</h4>
                        <p><a href="/about">About</a> <span><i class="ti-angle-right"></i></span> Privacy</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row ps-main-section">
                ...
                <div class="col-md-8 col-lg-9">
                    ...
                    <?php echo \App\Http\Controllers\HomeController::langchange(html_entity_decode($settings->privacy_policy)); ?>
                    </div>
                </div>
