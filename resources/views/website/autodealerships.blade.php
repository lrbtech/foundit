            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="single-content">
                        <h2>{{$language[127][session()->get('lang')]}}</h2>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">{{$language[127][session()->get('lang')]}}</li>
                        </ol>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="translate about-content">
                        <?php echo \App\Http\Controllers\HomeController::langchange(html_entity_decode($settings->autodealerships)); ?>
                    </div>
