...
<head>
	...
	<title>Invoiced Technologies</title>
	<style type="text/css">
...
<body style="-webkit-text-size-adjust: none;-ms-text-size-adjust: none;margin: 0;padding: 0;background: #fff;color: #b9b9b9;font-family: Helvetica, Arial, sans-serif;font-size: 14px;">
	<table cellpadding="0" cellspacing="0" width="100%" border="0" class="outer" style="background: #2d87ba;"  bgcolor="#2d87ba">
		<tr>
			<td height="10" class="sub-header">
		...
		<tr>
			<td height="50" class="spacer" style="font-size: 1px;line-height: 1px;">&nbsp;</td>
		</tr>
		<tr>
			<td class="header">
				<table cellpadding="0" cellspacing="0" width="640" border="0" class="container" align="center">
					<tr class="widget-header">
						...
						<td style="padding-bottom: 20px">
							<h1 style="color: #fff;font-family: Helvetica, Arial, sans-serif;font-size: 20px;font-weight: bold;text-transform: uppercase;line-height: 1.1x;padding-right: 20px;margin: 0;">{{$post->title}}</h1>
						</td>
						<td class="spacer w30" width="30" style="font-size: 1px;line-height: 1px;">&nbsp;</td>
					</tr>
		<?php
							...
							<table cellpadding="0" cellspacing="0" width="100%" border="0">
								<tr>
									<td valign="middle" align="left" class="logo mobile-block">
										<img src="{{$url}}upload_image/{{$post->image}}">
									</td>
								</tr>
							</table>
						</td>
	...
	<table cellpadding="0" cellspacing="0" width="100%" border="0" class="outer" style="background: #f0f0f0;" bgcolor="#f0f0f0">	
		<tr>
			<td class="content" style="font-size: 14px;line-height: 25px;font-family: Helvetica, Arial, sans-serif;color: #333;">
				<table cellpadding="0" cellspacing="0" width="640" border="0" class="container" bgcolor="#f0f0f0" align="center">
					<tr>
							...
							<table class="widget w580" cellpadding="0" cellspacing="0" border="0" align="center" style="width: 580px;">
								<tr class="widget-header">
									<td height="55" style="border-bottom: 5px #2d87ba solid;">
										<h1 style="color: #2d87ba;font-family: Helvetica, Arial, sans-serif;font-size: 20px;font-weight: bold;text-transform: uppercase;line-height: 36px;padding-right: 20px;margin: 0;">{{$category->category}}</h1>
									</td>
								</tr>
								<tr>
								...
								<tr class="widget-content">
									<td>
										...
										<h2 style="font-weight: bold;font-size: 16px;color: #2d87ba;">Description</h2>
										<p style="margin: 0 0 20px;padding: 0;font-size: 14px;line-height: 25px;font-family: Helvetica, Arial, sans-serif;color: #333;">{{$post->description}} </p>										
										...
										<table cellpadding="0" cellspacing="0" border="0" align="center" class="button" bgcolor="#2d87ba">
											<tr>
												...
												<td valign="middle" align="center" height="43" class="button-link" style="color: #151515;font-family: Helvetica, Arial, sans-serif;font-size: 15px;font-weight: bold;text-transform: uppercase;text-decoration: none;">
													<a target="_blank" href="{{$url}}view-post/{{$post->id}}" style="text-decoration: none;color: #fff;font-family: Helvetica, Arial, sans-serif;font-size: 15px;font-weight: bold;text-transform: capitalize;"><span style="color: #fff;font-family: Helvetica, Arial, sans-serif;font-size: 15px;font-weight: bold;text-transform: capitalize;text-decoration: none;">View Post</span></a>
												</td>
												<td class="spacer" width="15" style="font-size: 1px;line-height: 1px;">&nbsp;</td>
											</tr>
										</table>
		...
		<tr>
			<td class="footer" style="background: #f0f0f0;" bgcolor="#f0f0f0">
				<table cellpadding="0" cellspacing="0" width="640" border="0" class="container" align="center">
					<!-- <tr>
