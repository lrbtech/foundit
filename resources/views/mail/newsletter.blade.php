							...
							<table class="widget w580" cellpadding="0" cellspacing="0" border="0" align="center" style="width: 580px;">
								<tr class="widget-header">
									<td height="55" style="border-bottom: 5px #2d87ba solid;">
										<h1 style="color: #2d87ba;font-family: Helvetica, Arial, sans-serif;font-size: 20px;font-weight: bold;text-transform: uppercase;line-height: 36px;padding-right: 20px;margin: 0;">{{$newsletter->subject}}</h1>
									</td>
								</tr>
								<tr>
								...
								<tr class="widget-content">
									<td>
										<p style="margin: 0;padding: 0;font-size: 14px;line-height: 25px;font-family: Helvetica, Arial, sans-serif;color: #333;">{{$newsletter->message}}</p>
									</td>
								</tr>
								<tr>
