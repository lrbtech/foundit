    ...
    <div class="page-header">
      <div class="row">
        <div class="col-lg-6 main-header">
          <h2>Update <span>Ad Banner</span></h2>
              ...
              <div class="row">
                ...
                <div class="col-sm-12 col-md-12">
                  <div class="form-group">
                    <label class="form-label">Upload Ad Banner</label>
                    <input class="form-control" type="file" id="image" name="image">
                    <img style="width:100px;height:100px;" src="/upload_files/{{$settings->image}}">
                  </div>
                </div>
