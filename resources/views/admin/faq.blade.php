            ...
            <div class="page-header">
              <div class="row">
                <div class="col-lg-6 main-header">
                  <h2>{{$language[54][Auth::guard('admin')->user()->lang]}}</h2>
...
<div class="modal fade" id="popup_modal"  tabindex="-1" role="dialog" aria-labelledby="popup_modal" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <div class="form-group">
            ...
            <input autocomplete="off" type="text" id="question" name="question" class="form-control">
        </div>

        <div class="form-group">
            <label class="col-form-label">Answer</label>
            <textarea rows="6" id="answer" name="answer" class="form-control"></textarea>
        </div>
...
function Delete(id,status){
    ...
    if (r == true) {
      $.ajax({
        url : '/admin/delete-faq/'+id+'/'+status,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
