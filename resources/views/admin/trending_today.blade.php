            ...
            <div class="page-header">
              <div class="row">
                <div class="col-lg-6 main-header">
                  <h2>Trending Today <span> </span></h2>
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="display" id="basic-1">
                        ...
                        <tbody>
                        @foreach($trending_today as $key => $row)
...
<script>
  ...
  $sortable.sortable({
      stop: function ( event, ui ) {
          ...
          $.ajax({
            url : '/admin/update-trending-today',
            type: "POST",
            data: {
              value:parameters,
              _token: '{{csrf_token()}}'
...
$('.trending-today').addClass('active');
...
$('#add_new').click(function(){
    ...
    $('#modal-title').text('Add Trending Today');
});

function Save(){
  var formData = new FormData($('#form')[0]);
    $.ajax({
        url : '/admin/save-trending-today',
        type: "POST",
        data: formData,
        contentType: false,
        processData: false,
...
function Delete(id){
    ...
    if (r == true) {
      $.ajax({
        url : '/admin/delete-trending-today/'+id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
