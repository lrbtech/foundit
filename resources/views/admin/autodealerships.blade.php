...
<div class="page-body">
    ...
    <div class="page-header">
      <div class="row">
        <div class="col-lg-6 main-header">
          <h2>{{$language[51][Auth::guard('admin')->user()->lang]}}</h2>
  ...
  <div class="container-fluid">
    <div class="edit-profile">
      <div class="row">
        <div class="col-lg-12">
          <form action="/admin/update-autodealerships" id="form" method="POST" class="card theme-form" enctype="multipart/form-data">
          {{ csrf_field() }}
